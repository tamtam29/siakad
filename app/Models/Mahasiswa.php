        ...
        return Datatables::of($model)
                ->addColumn('action', function ($data) {
                    ...
                    $html = '<div class="button-demo">
                        <a href="'.url('mahasiswa/'.$data->id).'/edit" type="button" class="btn btn-info waves-effect">Edit</a>
                        <a href="#" type="button" data-url="'.url('mahasiswa/'.$data->id).'" class="btn btn-danger waves-effect delete-data">Delete</a>
                    </div>';
